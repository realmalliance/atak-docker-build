...
RUN keytool -keystore my-debug-key.keystore -genkey -noprompt -keyalg RSA -alias debug -dname "CN=Unknown, OU=Unknown, O=\"Realm\", L=Austin, ST=Texas, C=US" -storepass atakatak -keypass atakatak \
    && keytool -keystore my-release-key.keystore -genkey -noprompt -keyalg RSA -alias release -dname "CN=Unknown, OU=Unknown, O=\"Realm\", L=Austin, ST=Texas, C=US" -storepass atakatak -keypass atakatak \
